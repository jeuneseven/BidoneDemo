...
enum Constants {
    ...
    enum Design {
        ...
        enum Size {
            ...
            static let mealCardMinWidth: CGFloat = 150
    ...
    enum Strings {
        ...
        static let selectCategoryTitle = String(localized: "Select a Category")
        static let selectCategoryDescription = String(localized: "Choose a category from the sidebar to browse meals.")
        static let selectMealTitle = String(localized: "Select a Meal")
        static let selectMealDescription = String(localized: "Choose a meal to see its details.")
    ...
    enum Icons {
        ...
        // Placeholder
        static let category = "fork.knife"
        static let meal = "menucard"
    }
